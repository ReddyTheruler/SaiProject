...
#echo $sel_query;
$sel_query="SELECT * FROM `details` WHERE `accmat` BETWEEN '$dt>= $dt' and '$df <= $dt'";


#echo $sel_query;
#$sel_query="SELECT accmat FROM details WHERE  ".$dt." >= '".$dt."' AND ".$dt." <= '".$df."'";
...
#$sel_query="SELECT * FROM details WHERE accmat BETWEEN $df and $dt ";
#$sel_query="Select * from details ORDER BY id desc;";
...
#if($row = mysqli_num_rows($result, $conn)) { 
